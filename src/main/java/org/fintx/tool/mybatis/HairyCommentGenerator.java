...
public class HairyCommentGenerator extends DefaultCommentGenerator {
     ...
     */
    //TODO 改写JavaMapperGenerator 添加@Mapper注解
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        // add no file level comments by default
        if(compilationUnit.isJavaInterface()/* && compilationUnit.getType().getShortNameWithoutTypeArguments().endsWith("Mapper")*/){
            Interface iface= ((Interface)compilationUnit);
            iface.addImportedType(new FullyQualifiedJavaType("org.apache.ibatis.annotations.Mapper"));
            iface.addAnnotation("@Mapper");
        }
    }
